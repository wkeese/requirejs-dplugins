define([
	...
	registerSuite({
		...
		reload: function () {
			...
			// Load another module that uses requirejs-dplugins/css! to load the same test1.css,
		...
		loadLayer: function () {
			...
			require.config({
				config: {
					"requirejs-dplugins/css": {
						layersMap: {
							"requirejs-dplugins/tests/css/module5.css":
								"requirejs-dplugins/tests/css/layer.css"
						}
					}
				}
			});
			...
			localRequire([
				"requirejs-dplugins/css!./css/module5.css"
			], d.callback(function () {
